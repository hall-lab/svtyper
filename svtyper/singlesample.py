...
#    pass
#
#def cache_relevant_reads(invcf_fh):
#    samples = get_samples()
#    for variant in get_variants(f):
#        # filter out non 'SVTYPE'
#        # filter out non 'BND', 'DEL', 'DUP', 'INV'
#        # get chromA, chromB, posA, posB, ciA, ciB
#        # fetch_flank = sample.get_fetch_flank(z)
#        # chrom_length = sample.bam.lengths[sample.bam.gettid(chrom)]
#        # lpos = max(pos + ci[0] - fetch_flank, 0)
#        # rpos = min(pos + ci[1] + fetch_flank, chrom_length)
#        # fetch_reads_from_bam(sample, chrom, lpos, rpos)
#
# NOTES:
...
# http://pysam.readthedocs.io/en/latest/api.html?highlight=get_tags
...
#
#
# >>> s =  setup_sample(test_cram, None, 1000000, 20)
# >>> test_region = ('NA12878', 'chr1', 872907, 874424)
# >>> sam_reads = s.bam.fetch('chr1', 872907, 874424)
# >>> r = next(sam_reads)
# >>> r
# <pysam.libcalignedsegment.AlignedSegment object at 0x7f4fa878fd50>
# >>> lr = LiteRead(r, 'chr1', 873500, 20)
# >>> lr
# <__main__.LiteRead object at 0x7f4fa33bc690>
# >>> json.dumps(lr, default=lite_read_json_encoder)
# '{"__LiteRead__": {"is_ref_seq": false, "cigar": [[0, 151]], "is_unmapped": false, "tags": {"MD": "73G77", "NM": 1, "MC": "151M", "XA": "chr1,-8725
# 60,151M,3;chr1,-872980,151M,3;chr1,-872873,101M4D50M,8;", "AS": 146, "RG": "2895909554", "MQ": 60, "PG": "MarkDuplicates", "XS": 136}, "reference_n
# ame": "chr1", "mapping_quality": 49, "reference_end": 872920, "is_reverse": true, "is_duplicate": false, "query_alignment_length": 151, "query_name
# ": "E00334:118:HNL7TCCXX:2:2124:7344:29156", "is_secondary": false, "is_supplementary": false, "reference_start": 872769, "query_length": 151}}'
# >>> lrj = json.dumps(lr, default=lite_read_json_encoder)
# >>> json.loads(lrj, object_hook=lite_read_json_decoder)
# >>> foo = type('LiteRead', (), {})()
# >>> foo.__dict__.update(json.loads(lrj)['__LiteRead__'])
